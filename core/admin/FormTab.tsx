...
const FormTab: React.FC<FormTabProps> = ({ formData, addField, updateField, deleteField, updatePageInfo }) => {
  ...
  const handleDelete = (id: string, label: string) => {
    if (window.confirm(`Delete the field "${label || 'Untitled'}"?`)) {
      deleteField(id);
    }
  };
    ...
    <div className="space-y-12 animate-fade-in">
      ...
      <div className="space-y-8 bg-slate-900/30 p-8 rounded-[2.5rem] border border-slate-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                className="w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 text-slate-300 text-sm resize-none"
                rows={2}
          ...
          <div className="space-y-4">
            <h4 className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Success Message</h4>
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 text-emerald-400 font-black"
      ...
      <div className="space-y-8">
        <div className="flex justify-between items-center border-b border-slate-700 pb-4">
          <h2 className="text-2xl font-black text-white uppercase tracking-tight">Form Fields</h2>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 flex-grow">
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-800 border border-slate-700 p-2 rounded-lg text-sm text-white" 
                  ...
                  <div className="space-y-1">
                    ...
                    <select 
                      ...
                      className="w-full bg-slate-800 border border-slate-700 p-2 rounded-lg text-sm text-slate-300 focus:outline-none"
                    >
                        ...
                        <option value="textarea">Large Message Box</option>
                    </select>
                  </div>
                  <div className="space-y-1">
                ...
                <div className="flex flex-col gap-2 shrink-0">
                  <button 
                    ...
                    className={`px-4 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${field.required ? 'bg-red-500 text-white' : 'bg-slate-700 text-slate-400'}`}
                  >
